...
export const windDirections = {
  N: { icon: "arrow-down", rotate: "0", name: "Norte" },
  S: { icon: "arrow-up", rotate: "0", name: "Sur" },
  E: { icon: "arrow-left", rotate: "0", name: "Este" },
  O: { icon: "arrow-right", rotate: "0", name: "Oeste" },
  W: { icon: "arrow-right", rotate: "0", name: "Oeste" },
